...
namespace FP300Service.UserControls
{
    public class UtililtyFuncsUC : TestUC
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.gbxFiscalMode.Location = new System.Drawing.Point(3, 16);
            this.gbxFiscalMode.Name = "gbxFiscalMode";
            this.gbxFiscalMode.Size = new System.Drawing.Size(534, 84);
            this.gbxFiscalMode.TabIndex = 19;
            this.gbxFiscalMode.TabStop = false;
            this.gbxFiscalMode.Text = "Mali Operasyonlar";
            // 
            // btnStartFM
            // 
            this.btnStartFM.Location = new System.Drawing.Point(6, 31);
            this.btnStartFM.Name = "btnStartFM";
            this.btnStartFM.Size = new System.Drawing.Size(147, 37);
            this.btnStartFM.TabIndex = 6;
            this.btnStartFM.Text = "Mali Bellek Başlat";
        ...
        private void btnStartFM_Click(object sender, EventArgs e)
        {
            try
            {
                InputBox ib = new InputBox("Mali Numara Giriniz(1-99999999) :", 8);
                if (ib.ShowDialog(this) == DialogResult.OK)
                {
                    ...
                    {
                        bridge.Log("Hata: Mali numara uygun değil");
                    }
